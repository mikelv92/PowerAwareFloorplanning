...
# variabile per assicurare distanza corretta tra regioni
var absX{n1 in N, n2 in N: n1 < n2} binary;
var absY{n1 in N, n2 in N: n1 < n2} binary;
...
subject to deltaAbsXCentroid_1{n1 in NC, n2 in NC : n1 < n2}:
	DCx[n1, n2] <= Cx[n1] - Cx[n2] + absX[n1, n2]*maxW*tileW;
subject to deltaAbsXCentroid_2{n1 in NC, n2 in NC : n1 < n2}:
	DCx[n1, n2] <= Cx[n2] - Cx[n1] + (1 - absX[n1, n2])*maxW*tileW;
...
subject to deltaAbsYCentroid_1{n1 in NC, n2 in NC : n1 < n2}:
	DCy[n1, n2] <= Cy[n1] - Cy[n2] + absY[n1, n2]*maxH*tileH;
subject to deltaAbsYCentroid_2{n1 in NC, n2 in NC : n1 < n2}:
	DCy[n1, n2] <= Cy[n2] - Cy[n1] + (1 - absY[n1, n2])*maxH*tileH;
...
# vincoli di distanza minimia
subject to minRegionDist{n1 in NC, n2 in NC}:
	DCx[n1,n2] + DCy[n1,n2] >= minDist[n1,n2];
...
subject to atRightCut{n1 in SNC, n2 in SNC: n1 > n2 and pair1[n1] < pair1[n2] and pair2[n1] < pair2[n2]}:
	absX[n2, n1] = 0;
subject to belowCut{n1 in SNC, n2 in SNC: n1 > n2 and pair1[n1] < pair1[n2] and pair2[n1] > pair2[n2]}:
	absY[n2, n1] = 1;	
	
subject to atLeftCut{n1 in SNC, n2 in SNC: n1 < n2 and pair1[n1] < pair1[n2] and pair2[n1] < pair2[n2]}:
	absX[n1, n2] = 1;
subject to aboveCut{n1 in SNC, n2 in SNC: n1 < n2 and pair1[n1] < pair1[n2] and pair2[n1] > pair2[n2]}:
	absY[n1, n2] = 0;
